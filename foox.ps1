...
#$dprx='http://test.corp.com:8080';$duprx='';$c='Get-SandboxVersion';$i='PackageManagement','PowerShellGet','Eigenverft.Manifested.Sandbox';
#Initialize-Compact -DefManProxy $dprx -DefManUser $duprx;
#Initialize-Bootstrap -c $c -i $i;
